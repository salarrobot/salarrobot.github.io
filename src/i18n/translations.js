export const translations = {
  en: {
    ...
    about: {
      ...
      interestsCols: { area: 'Research Area' },
      interests: [
      ...
      teaching: [
        {
          ...
          desc: 'Held weekly problem-solving sessions and graded assignments and exams.',
        },
        {
          ...
          location: 'Tabriz, Iran · On-site',
          desc: 'Mentored project teams and reviewed software design deliverables.',
        },
        {
          ...
          location: 'Tabriz, Iran · On-site',
          desc: 'Led recitations on algorithm analysis and graded problem sets.',
        },
        {
          ...
          lecturer: 'Dr. Seyed Amir Mortazavi',
          location: 'Tabriz, Iran · On-site',
          desc: 'Ran tutorial sessions and supported students with assignments.',
        },
        {
          ...
          lecturer: 'Dr. Seyed Amir Mortazavi',
          location: 'Tabriz, Iran · On-site',
          desc: 'Conducted problem-solving sessions and graded coursework.',
        },
      ],
    },
    projects: {
      ...
      more: [
        {
          name: 'Basketball System Analysis',
          desc: 'Computer-vision analysis of basketball gameplay and player tracking.',
          tech: 'Computer Vision',
        },
        {
          name: 'Brain Tumor Detection',
          desc: 'MRI brain-tumor classification with deep convolutional networks.',
          tech: 'Deep Learning',
        },
        {
          name: 'American Sign Language MNIST & Gesture Recognition CNNs',
          desc: 'Hand-gesture and ASL letter recognition using CNNs.',
          tech: 'CNN',
        },
        {
          name: 'Fake News Detection using DistilBERT & Transfer Learning',
          desc: 'Text classification with a fine-tuned DistilBERT transformer.',
          tech: 'NLP',
        },
        {
          name: 'Diabetes Prediction using Deep Learning',
          desc: 'Predicting diabetes risk from clinical features.',
          tech: 'Deep Learning',
        },
        {
          name: 'House Price Prediction with Data Preprocessing & Linear Regression',
          desc: 'Price regression with thorough feature preprocessing.',
          tech: 'Regression',
        },
        {
          name: 'Connect Four Game with AI Model',
          desc: 'Game-playing agent using adversarial search.',
          tech: 'Game AI',
        },
        {
          name: 'E-commerce with Groceries Recommender',
          desc: 'Recommendation engine for an online grocery store.',
          tech: 'Recommender',
        },
      ],
    },
  ...
  tr: {
    ...
    about: {
      ...
      interestsCols: { area: 'Araştırma Alanı' },
      interests: [
      ...
      hobbies: ['🎾 Tenis', '🚴 Bisiklet', '📚 Kitap Okuma'],
    },
    education: {
      title: 'Eğitim',
      items: [
      ...
      teaching: [
        {
          ...
          lecturer: 'Dr. Seyed Amir Mortazavi',
          location: 'Tebriz, İran · Yerinde',
          desc: 'Haftalık problem çözme oturumları düzenledim; ödev ve sınavları değerlendirdim.',
        },
        {
          ...
          lecturer: 'Dr. Leili Farzinvash',
          location: 'Tebriz, İran · Yerinde',
          desc: 'Proje ekiplerine mentorluk yaptım ve yazılım tasarım çıktılarını inceledim.',
        },
        {
          ...
          lecturer: 'Dr. Pedram Salehpour',
          location: 'Tebriz, İran · Yerinde',
          desc: 'Algoritma analizi oturumları yürüttüm ve problem setlerini değerlendirdim.',
        },
        {
          ...
          lecturer: 'Dr. Seyed Amir Mortazavi',
          location: 'Tebriz, İran · Yerinde',
          desc: 'Alıştırma oturumları düzenledim ve öğrencilere ödevlerde destek oldum.',
        },
        {
          ...
          lecturer: 'Dr. Seyed Amir Mortazavi',
          location: 'Tebriz, İran · Yerinde',
          desc: 'Problem çözme oturumları gerçekleştirdim ve ödevleri değerlendirdim.',
        },
      ],
    },
    projects: {
      ...
      more: [
        {
          name: 'Basketbol Sistem Analizi',
          desc: 'Basketbol oyununun ve oyuncu takibinin bilgisayarlı görü ile analizi.',
          tech: 'Bilgisayarlı Görü',
        },
        {
          name: 'Beyin Tümörü Tespiti',
          desc: 'Derin evrişimli ağlarla MRI beyin tümörü sınıflandırması.',
          tech: 'Derin Öğrenme',
        },
        {
          name: 'ASL MNIST ve El Hareketi Tanıma CNN’leri',
          desc: 'CNN’ler ile el hareketi ve ASL harf tanıma.',
          tech: 'CNN',
        },
        {
          name: 'DistilBERT ve Transfer Öğrenme ile Sahte Haber Tespiti',
          desc: 'İnce ayarlı DistilBERT modeli ile metin sınıflandırma.',
          tech: 'NLP',
        },
        {
          name: 'Derin Öğrenme ile Diyabet Tahmini',
          desc: 'Klinik özelliklerden diyabet riski tahmini.',
          tech: 'Derin Öğrenme',
        },
        {
          name: 'Veri Ön İşleme ve Doğrusal Regresyon ile Ev Fiyatı Tahmini',
          desc: 'Kapsamlı özellik ön işlemeyle fiyat regresyonu.',
          tech: 'Regresyon',
        },
        {
          name: 'Yapay Zeka Modelli Connect Four Oyunu',
          desc: 'Rakip arama yöntemiyle oyun oynayan ajan.',
          tech: 'Oyun YZ',
        },
        {
          name: 'Market Ürünü Öneri Sistemli E-ticaret',
          desc: 'Çevrimiçi market için öneri motoru.',
          tech: 'Öneri Sistemi',
        },
      ],
    },
