export const translations = {
  en: {
    ...
    about: {
      title: 'About Me',
      bio: "As a Master's student in Electrical Engineering at National Taiwan Normal University (NTNU), I work on Reinforcement Learning and Deep Reinforcement Learning for humanoid robotics under the supervision of Dr. Saeed Saeedvand. Before that, I completed my B.Sc. in Computer Engineering at the University of Tabriz and worked on industrial AI projects such as Automated Optical Inspection. I enjoy teaching, sharing knowledge, and building intelligent systems that interact with the real world.",
